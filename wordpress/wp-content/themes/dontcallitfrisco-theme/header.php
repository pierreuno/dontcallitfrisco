	    ...
	    <div class="container">
	      ...
	      <div id="navbar">
	        <ul class="nav navbar-nav">
	          <li><a href="<?php echo home_url(); ?>"><span class="header"></span><span>Home</span></a></li>
	          <li><a href="<?php echo home_url(); ?>#episodes"><span class="header"></span><span>Episodes</span></a></li>
